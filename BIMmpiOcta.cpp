...
#include"./Headers/BIMcurvedLinUOcta.h"
#include<mpi/mpi.h>
...
int main(int argc, char **argv)
{
    ...
    ThreeDVector initPts[] = {ThreeDVector(0, 1, 0), ThreeDVector(-1, 0, 0), ThreeDVector(0, -1, 0), ThreeDVector(1, 0, 0),
                                ThreeDVector(0, 0, 1), ThreeDVector(0, 0, -1)}; //vertices of octahedron.
    
    BIMobjects spheroid(initPts, 6);    // no. of vertices of octahedron = 6.
